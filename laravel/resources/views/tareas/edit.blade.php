    ...
    <div class="max-w-lg mx-auto">
        ...
        <form method="POST" action="{{ route('tareas.update', $tarea) }}"
            ...
            @php
                ...
                $estadoActual = old('estado', $tarea->estado?->value ?? 'pendiente');
            @endphp
            ...
            <div class="mb-5 animate-fade-in-up [animation-delay:120ms]">
                ...
                <textarea id="descripcion" name="descripcion" rows="4"
                    class="shadow-sm appearance-none border border-gray-200 rounded-lg w-full py-2.5 px-3 text-gray-700 leading-tight
                           transition-all duration-200 outline-none
                           focus:ring-2 focus:ring-purple-500/30 focus:border-purple-500 hover:border-gray-300">{{ old('descripcion', $tarea->descripcion) }}</textarea>
            </div>
