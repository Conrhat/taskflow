...
@section('content')
    ...
    <div class="max-w-lg mx-auto">
        ...
        <form method="POST" action="{{ route('tareas.store') }}" class="bg-white rounded-xl shadow-md p-6">
            @csrf
            ...
            <div class="mb-6">
                ...
                <textarea id="descripcion" name="descripcion" rows="4"
                    class="shadow appearance-none border rounded-lg w-full py-2 px-3 text-gray-700 leading-tight
                           focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500">{{ old('descripcion') }}</textarea>
            </div>
            ...
            <div class="mb-6">
                ...
                <select id="estado" name="estado"
                    ...
                    @foreach (\App\Enums\EstadoTarea::cases() as $estado)
                        <option value="{{ $estado->value }}" @selected(old('estado', 'pendiente') == $estado->value)>
