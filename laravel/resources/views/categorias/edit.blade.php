...
@section('content')
    <div class="max-w-lg mx-auto">
        ...
        <form method="POST" action="{{ route('categorias.update', $categoria) }}" class="bg-white rounded-xl shadow-md p-6">
            @csrf
            @method('PUT')

            <div class="mb-6">
                <label for="nombre" class="block text-gray-700 text-sm font-bold mb-2">Nombre</label>
                <input id="nombre" type="text" name="nombre" value="{{ old('nombre', $categoria->nombre) }}" required autofocus
